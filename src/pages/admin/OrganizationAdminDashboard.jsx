        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Welcome, {user?.name}. Manage your organization and volunteer opportunities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/org/opportunities')}>
              <CardHeader>
              ...
              <CardContent>
                ...
                <Button variant="ghost" className="w-full mt-4 text-orange-500 hover:text-orange-600 hover:bg-orange-50">
                  View Opportunities
                </Button>
              </CardContent>
            </Card>
            
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/org/volunteers')}>
              <CardHeader>
            ...
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/org/organization')}>
              <CardHeader>

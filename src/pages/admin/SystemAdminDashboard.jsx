      ...
      <main className="flex-grow pt-32 pb-24 px-6 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/system/users')}>
              <CardHeader>
            ...
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/system/organizations')}>
              <CardHeader>
            ...
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/system/opportunities')}>
              <CardHeader>
            ...
            <Card className="hover-card-shadow transition-all duration-300 cursor-pointer" onClick={() => navigate('/admin/system/settings')}>
              <CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center pb-4 border-b">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Green Earth Initiative was approved</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center pb-4 border-b">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">John Doe promoted to Organization Admin</p>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Email notification settings were modified</p>
                    </div>
                    <div className="text-right">
